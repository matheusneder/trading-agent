...
namespace TradingAgent
{
    public class BinanceApiAdapter : BinanceApiAdapterBase
    {
        ...
        public async Task CreateSellOrderAsync(int tradingId, string holdAsset, string tradeAsset, decimal tradeAssetQty, decimal sellPrice, decimal sellStopTriggerPrice, decimal sellStopLimitPrice, string sellOrderBinanceIdSuffix)
        {
